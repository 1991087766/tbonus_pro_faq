...
_Tbonus Pro_ 是一款由 _GW TECHNOLOGY CO.,LTD._ （以下简称”我们“）提供的产品。 您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务时，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。 本《隐私政策》与您所使用的 _Tbonus Pro_ 服务息息相关，希望您仔细阅读，在需要时，按照本《隐私政策》的指引，作出您认为适当的选择。本《隐私政策》中涉及的相关技术词汇，我们尽量以简明扼要的表述，并提供进一步说明的链接，以便您的理解。

**您使用或继续使用我们的服务，即意味着同意我们按照本《隐私政策》收集、使用、储存和分享您的相关信息。**

如对本《隐私政策》或相关事宜有任何问题，请通过 **tbonuspro@tokencan.app** 与我们联系。
...
* **日志信息**，指您使用我们的服务时，系统可能通过cookies、标识符及相关技术收集的信息，包括您的**设备信息(IMEI/MAC/Android ID/IDFA/OpenUDID/GUID/BSSID/SIM 卡 IMSI 信息等)**、**浏览信息(TbonusPro App的页面信息)**、**点击信息（数据埋点）**，并将该等信息储存为日志信息，为您提供个性化的用户体验、保障服务安全。您可以通过浏览器设置拒绝或管理cookie、标识符或相关技术的使用。
...
* 友盟(https://www.umeng.com/)
  * Android
    * 服务类型：统计分析
    * 收集个人信息类型：设备信息（IMEI/MAC/Android ID/IDFA/OpenUDID/GUID/IP地址/BSSID/SIM 卡 IMSI 信息等）
...
* 个推(https://www.getui.com/notification-push)
    * 服务类型：消息推送
    * 收集个人信息类型：
      * 设备信息：包含设备平台、设备厂商及品牌、设备型号及系统版本、设备识别码、设备序列号，用于我们标识到独立设备实现向特定用户推送消息。
      ...
      * 特别说明：我们在向您推送消息时，我们可能会授权每日互动股份有限公司进行链路调节，相互促活被关闭的SDK推送进程，保障您可以及时接收到我们向您推送的消息。
    * 隐私权政策链接：https://docs.getui.com/privacy/
* Tokencan
  * 服务类型：第三方登录
  * 使用个人信息类型：
    * Tokencan的账号信息
    * 设备信息（IMEI/MAC/Android ID/IDFA/OpenUDID/GUID/IP地址/SIM 卡 IMSI 信息、BSSID等）
  * 隐私权政策链接：https://tokencanassist.zendesk.com/hc/zh-cn/articles/900001018866-%E9%9A%90%E7%A7%81%E6%9D%A1%E6%AC%BE
